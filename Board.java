...
public class Board {
    ...
    public int minmaxO(int depth, int turn) {
        ...
        for (int i = 0; i < availableCells.size(); i++) {
            ...
            if (turn == PLAYER_O) {
                ...
                int currentScore = minmaxO(depth + 1, PLAYER_X);
               ...
               /* if  (depth == 0) {
                ...
                int currentScore = minmaxO(depth + 1, PLAYER_O);
    ...
    public int minmaxX(int depth, int turn) {
        ...
        for (int i = 0; i < availableCells.size(); i++) {
            ...
            if (turn == PLAYER_X) {
                placeAMove(point, PLAYER_X);
                int currentScore = minmaxX(depth + 1, PLAYER_O);
                max = Math.max(currentScore, max);
                /*if  (depth == 0) {
                    System.out.println("Computer score for position " + point + " = " + currentScore);
                }*/
                ...
                placeAMove(point, PLAYER_O);
                int currentScore = minmaxX(depth + 1, PLAYER_X);
                min = Math.min(currentScore, min);
                if (min == -1) {
                    board[point.x][point.y] = NO_PLAYER;
                    break;
